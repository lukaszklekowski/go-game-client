...
/**
 * Klasa model odpowiedzialna za logikę okna tworzącego nową grę.
 */
public class CreateGameModel {
    LobbyCommunication lobbycomm;
    boolean nicksended;

    CreateGameModel(LobbyCommunication lobbyCommunication){
        this.lobbycomm = lobbyCommunication;
        this.nicksended = false;
    }

    /**
     * Metoda tworzy klasę tworzącą plansze
     */
    ...
    public String sendNewGame(String GameName, String Type) throws IOException {
        String answer = null;
        lobbycomm.out.println("CREATE_GAME " +GameName + " " + Type);
        lobbycomm.out.flush();
